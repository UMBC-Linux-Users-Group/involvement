...
\begin{tabular*}{\hsize}{>{\raggedright}p{0.23\hsize}p{0.1\hsize}p{0.55\hsize}}
    ...
    Linux Awareness Week & Sept~27-Oct~2 & Celebrate and be aware of
        Linux in your life in the week leading up to Installfest. \\

    InstallFest & Oct~2 & Let us help you try Linux, or install it
        for you. \\
